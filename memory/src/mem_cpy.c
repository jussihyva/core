...
static inline
void	copy_small(t_byte *dst, const t_byte *restrict src, t_size n)
{
	if (n >= 8)
	{
...
static inline
void	copy512(t_uint64 *dst, const t_uint64 *restrict src, t_size n)
{
	t_size	chunks;
	t_size	offset;
...
void	*mem_cpy(void *dst, const void *restrict src, t_size n)
{
	t_byte			*dst8;
	const t_byte	*src8;
	t_size			qwords;
